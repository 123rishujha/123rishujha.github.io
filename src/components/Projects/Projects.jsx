...
const Projects = () => {
  ...
  let data = [
    ...
    },
    {
      title:'Stylish World',
      img:stylish,
      description:'An e-commerce website that provides you with fashion-related products.',
    ...
    },
    {
      ...
      img:electronic,
      description:'An e-commerce website that provides you with electronic-related products.',
      techstack:['HTML,CSS,JAVASCRIPT','REACT'],
    ...
    },
    {
      title:'Resell',
      img:resell,
      description:'Ecommerce website where users can do online shopping and search for their choice',
